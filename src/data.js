...
export const RESOURCES = [
  { id: 'food',    name: 'Food',    tier: 0 },
  { id: 'wood',    name: 'Wood',    tier: 0 },
  { id: 'stone',   name: 'Stone',   tier: 0 },
  { id: 'ore',     name: 'Ore',     tier: 1 },
  { id: 'hide',    name: 'Hide',    tier: 1 },
  { id: 'herbs',   name: 'Herbs',   tier: 1 },
  { id: 'metal',   name: 'Metal',   tier: 2 },
  { id: 'leather', name: 'Leather', tier: 2 },
  { id: 'tonic',   name: 'Tonic',   tier: 2 },
  { id: 'tools',   name: 'Tools',   tier: 3 },
  { id: 'gear',    name: 'Gear',    tier: 3 },
  { id: 'coins',   name: 'Coins',   tier: 4 },
  { id: 'essence', name: 'Essence', tier: 5 },
];
...
export const JOBS = [
  { id: 'forage',    name: 'Forager',   verb: 'foraging',  yield: { food: 0.8 } },
  { id: 'logging',   name: 'Logger',    verb: 'logging',   yield: { wood: 0.5 } },
  { id: 'quarry',    name: 'Quarrier',  verb: 'quarrying', yield: { stone: 0.35 },
    unlock: s => (s.buildings.stonePit || 0) > 0 || s.res.stone >= 10 },
  { id: 'hunting',   name: 'Hunter',    verb: 'hunting',   yield: { hide: 0.2, food: 0.2 },
    unlock: s => s.unlocked.tier1 },
  { id: 'herbalism', name: 'Herbalist', verb: 'gathering herbs', yield: { herbs: 0.25 },
    unlock: s => s.unlocked.tier1 },
  { id: 'mining',    name: 'Miner',     verb: 'mining',    yield: { ore: 0.4 },
    unlock: s => s.unlocked.tier1 },
];
...
export const CONVERTERS = [
  { id: 'smelter',  name: 'Smelter',  desc: 'Ore in, metal out.',
    cycle: 10, input: { ore: 6, wood: 4 },   output: { metal: 1 },
    cost: { stone: 400, wood: 200 },  costMult: 1.2,
    unlock: s => s.unlocked.tier1 },
  { id: 'tannery',  name: 'Tannery',  desc: 'Hides cure on long racks.',
    cycle: 8,  input: { hide: 5 },           output: { leather: 1 },
    cost: { wood: 350, stone: 150 },  costMult: 1.2,
    unlock: s => s.unlocked.tier1 },
  { id: 'still',    name: 'Still',    desc: 'Herbs boil down to fortifying tonic.',
    cycle: 8,  input: { herbs: 6, food: 4 }, output: { tonic: 1 },
    cost: { wood: 350, stone: 150 },  costMult: 1.2,
    unlock: s => s.unlocked.tier1 },
  { id: 'workshop', name: 'Workshop', desc: 'Handles, hafts, and honed edges.',
  ...
  { id: 'forge',    name: 'Forge',    desc: 'Expedition gear: plated, strapped, tested.',
...
export const BLESSINGS = [
  { id: 'vigor',    name: 'Blessing of Vigor',
    ...
    base: 10, mult: 1.7 },
  { id: 'haste',    name: 'Blessing of Haste',
    desc: '+20% converter speed per rank.',
    base: 15, mult: 1.7 },
  { id: 'insight',  name: 'Blessing of Insight',
    desc: '+50% job XP per rank.',
    base: 10, mult: 1.7 },
  { id: 'valor',    name: 'Blessing of Valor',
    desc: '+25% expedition progress per rank.',
    base: 20, mult: 1.7 },
  { id: 'patience', name: 'Blessing of Patience',
    desc: '+4 hours offline cap per rank.',
    base: 25, mult: 2.0, max: 8 },
  { id: 'foresight', name: 'Blessing of Foresight',
...
export const RULE_ACTIONS = [
  ...
  { id: 'recruit',      name: 'Recruit villager' },
  { id: 'sellSurplus',  name: 'Sell surplus of resource (down to threshold)' },
